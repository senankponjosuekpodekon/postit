<template>  
    ...
    <div v-for="(notes, index) in this.notes" :key="index">
            ...
            <div class="container">
                <div class="p-2 w-35">
                    <div class="col card card-body">
                        <h5 class="text-truncate">{{notes.title}} <i class="point fa fa-circle ml-1 font-10 text-warning"></i></h5>
                        <p class="font-12">{{notes.createdAt}} </p>
                        <p class="">{{notes.content[0]}}</p>
...
export default {
    ...
    methods: {
        ...
        getNotes(){
             ...
             axios.get(`http://62.72.5.95:1999/notes`)
             .then(res => {
