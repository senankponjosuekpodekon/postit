<template>  
    ...
    <div v-for="count in totalPostit.id" :key="count.id">
         <!-- {{count.title}} --> 
                ...
                <div class="p-2 w-35">
                    <div class="col card card-body">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ml-auto">              
                              <!-- <button type="button" class="btn btn-info mx-2"><router-link :to="`/notes/${count._id}`">Details</router-link></button> -->
                                <!-- <form action="/notes/${count._id}`"> -->
                              <button type="button" @click="show(count._id)" class="btn btn-info mx-2">Show</button>
                                <!-- </form> -->
                              <button type="button" class="btn btn-secondary mx-2"><router-link :to="`/notes/${count._id}/edit`">Edit</router-link></button>
...
//  const totalPostitRefs = ref([])
    ...
    await fetch(`http://62.72.5.95:1999/notes/${id}`, { method: 'DELETE' });
    ...
    const show = async(id) => {
    await fetch(`http://62.72.5.95:1999/notes/${id}`, { method: 'GET' });
    };
