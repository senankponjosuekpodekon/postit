    ...
    <form action="" method="post" @submit.prevent="onSubmit" class="vh-100" style="background-color: #2779e2;">
        ...
        <div class="row d-flex justify-content-center align-items-center h-100">
            <div class="col-xl-9">
                ...
                <h2 class="text-white mb-4">Ajouter une note :</h2>
                ...
                <div class="card" style="border-radius: 15px;">
                    <div class="card-body">
                        ...
                        <div class="px-5 py-4">
                            <button type="submit" @click="saveNotes" class="btn btn-primary btn-lg">Enregister</button>
                        </div>
                    </div>
                </div>
            </div>
...
export default {
    ...
    methods: {
        saveNotes(){
            var mythis = this;
            axios.post('https://post-it.epi-bluelock.bj/notes/', this.model.notes)
            .then(res => {
